...
\begin{Parallel}[v]{0.485\textwidth}{0.485\textwidth}
\ParallelLText{
\textcolor{my-color}{Deus Israel coniugat vos: et ipse sit vobiscum, qui misertus est duo bus unicis: et nunc, Domine, fac eos plenius benedicere te.}
...
\textcolor{my-color}{Przyjdź, Uświęcicielu, wszechmogący, wieczny Boże, i pobłogo \SmallCross sław tę ofiarę, przygotowaną Twemu świętemu Imieniu.}
}
\end{Parallel}
...
\ParallelRText{
\textcolor{my-color}{Ciebie przeto, najmiłościwszy Ojcze, pokornie i usilnie błagamy przez Jezusa Chrystusa Syna Twego, Pana naszego, abyś łaskawie przyjął i błogosławił te \SmallCross dary, te \SmallCross daniny, te \SmallCross święte ofiary nieskalane.}
}
\end{Parallel}
...
\begin{Parallel}[v]{0.485\textwidth}{0.485\textwidth}
\ParallelLText{
\textcolor{my-color}{Quam oblatiónem tu, Deus, in ómnibus, quaesumus, bene \SmallCross díctam, adscríp \SmallCross tam, ra \SmallCross tam, rationábilem, acceptabilémque fácere dignéris: ut nobis Cor \SmallCross pus, et San \SmallCross guis fiat dilectíssimi Fílii tui, Dómini nostri Iesu Christi. }
}
