...
%\definecolor{my-color}{rgb}{0.0, 0.18, 0.39} % granatowy
...
\begin{Parallel}[v]{0.485\textwidth}{0.485\textwidth}
\ParallelLText{
\noindent\textcolor{my-color}{HOC EST ENIM CORPUS MEUM.}
}
\ParallelRText{
\noindent\textcolor{my-color}{TO JEST BOWIEM CIAŁO MOJE.}
}
\end{Parallel}
...
\ParallelRText{
\textcolor{my-color}{Racz wejrzeć na nie miłościwym i~pogodnym obliczem i~z upodobaniem przyjąć, jak raczyłeś przyjąć dary sługi Swego sprawiedliwego Abla i~ofiarę Patriarchy naszego Abrahama, oraz tę, którą Ci złożył najwyż\-szy Twój kapłan Melchizedek, ofiarę świętą, hostię niepokalaną.}
}
\end{Parallel}
...
\begin{Parallel}[v]{0.485\textwidth}{0.485\textwidth}
\ParallelLText{
\textcolor{my-color}{Corpus tuum, Domine, quod sum\-psi, et Sanguis, quem potavi, adhaereat visceribus meis: et praesta, ut in me non remaneat scelerum macula, quem pura et sancta refecerunt sacramenta. Qui vivis et regnas in saecula saeculorum. Amen.}
}
...
\begin{center}
\textbf{Communio --- Antyfona na Komunię}
\end{center}
...
\textcolor{my-color}{Na początku było Słowo, a~Słowo było u~Boga i~Bogiem było Słowo. Ono było na początku u~Boga. Wszy\-stko przez Nie się stało, a~bez Niego nic się nie stało, co się stało. W~Nim było życie, a~życie było światłością ludzi, a~światłość w~ciemnościach świeci i~ciemności jej nie ogarnęły.
...
\begin{center}
	\textcolor{red}{Ze względu na długość utworu muzycznego na wyjście (5 -- 6 minut) proponujemy pozostać chwilę dłużej i~posłuchać.}
\end{center}
